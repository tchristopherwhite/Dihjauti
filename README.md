...
<img width="740" alt="D2" src="https://github.com/user-attachments/assets/550c725b-7174-44f1-a1de-9b9db1e09f80">
...
--UPDATES-- This version (3.1.0) has some fixed kerning issues in the Regular version (which I somehow missed), some missed and new additions in the i/j comp/decomp table, a few glyph corrections in the Bold-Italic, and about 100 new glyphs added for transcription systems.
...
Dihjauti is two typefaces: Dihjauti, and Dihjauti S. The only difference are the 'Q's in Dihjauti S, which are Scotch styled, thus the 'S' in the name.
