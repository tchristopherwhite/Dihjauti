...
--UPDATES-- This version (3.1.0) has some fixed kerning issues in the Regular version (which I somehow missed), some missed and new additions in the I comp/decomp table, a few glyph corrections in the Bold-Italic, and about 100 new glyphs added for transcription systems.
